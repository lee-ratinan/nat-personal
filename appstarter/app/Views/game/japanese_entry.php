...
?>
    <div class="row">
        <div class="col">
            <h1>日本語 (Japanese)</h1>
            <p>Get ready to play the game | <a href="<?= base_url('game/japanese') ?>">Back</a></p>
            <hr>
            <p><b>Rules:</b> <?= str_replace('(kana)', $the_kana, $rules[$game]) ?></p>
            <div class="my-5 text-center">
                <a class="btn btn-outline-danger w-100" href="<?= base_url('game/japanese/game/' . $game . '/' . $kana_set) ?>">
                    START
                </a>
            </div>
        </div>
